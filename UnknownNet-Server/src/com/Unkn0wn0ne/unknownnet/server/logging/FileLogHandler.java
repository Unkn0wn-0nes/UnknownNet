...
public class FileLogHandler extends Handler implements Runnable{
	...
	public void publish(LogRecord arg0) {
		if (arg0.getThrown() != null) {
			...
			strBuilder.append("[" );
			strBuilder.append(arg0.getLevel().getName());
			strBuilder.append("] ");
			strBuilder.append(arg0.getMessage());
			strBuilder.append(" Message: ");
			strBuilder.append(arg0.getThrown().getClass().getSimpleName());
			strBuilder.append(" ");
			strBuilder.append(arg0.getThrown().getMessage());
			strBuilder.append(" Stack trace: \n");
			
			for (StackTraceElement sTE : arg0.getThrown().getStackTrace()) {
				strBuilder.append(sTE.toString());
				strBuilder.append("\n");
			}
			this.logs.add(strBuilder.toString());
		} else {
			this.logs.add(arg0.getMessage());
		}
	}
